...
<section class="orders">
        <div class="title">
            ...
            <h1>my orders</h1>
            <p>Track All Your Previous Purchases And Current Orders Right Here. We Ensure The Best Quality And Timely Delivery For Every Order You Place With Us.</p>
        </div>
    ...
    <div class="box-container">
        ...
        <div class="box" <?php if($fetch_order['status'] == 'cancle'){echo 'style="border:2px solid red;";';} ?>>
            <a href="view_order.php?get_id=<?= $fetch_order['id']; ?>">
                <p class="date"><span><?= $fetch_order['date']; ?></span></p>
