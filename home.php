...
<body>
    ...
    <div class="box-container">
        <div class="box">
            <img src="img/thumb2.jpg" alt="green tea">
            <h3>green tea</h3>
        ...
        <div class="box">
            <img src="img/thumb0.jpg" alt="lemon tea">
            <h3>lemon tea</h3>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
            <i class="bx bx-chevron-right"></i>
        </div>
        ...
        <div class="box">
            <img src="img/thumb1.jpg" alt="green coffee">
            <h3>green coffee</h3>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
            <i class="bx bx-chevron-right"></i>
        </div>
        ...
        <div class="box">
            <img src="img/thumb.jpg" alt="black tea">
            <h3>green tea</h3>
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit.</p>
            <i class="bx bx-chevron-right"></i>
        </div>
    ...
    <div class="container">
        <div class="box-container">
            ...
            <div class="box">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adialiquip cincididunt ut labore et dolore magm</p>
            </div>
        </div>
    </div>
</section>
...
<section class="brand">
    ...
    </div> <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
